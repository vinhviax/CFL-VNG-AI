# Config — GS9 CFL Knowledge Curator
...
- **Tên trên Web:** `GS9 CFL Knowledge Curator` — đổi tiền tố `GS9` → `GS9 CFL` ngày 15/08/2026, đã đọc trực tiếp trong dialog
...
- **Knowledge Base:** `GS9 Knowledge VNG AI` + `GS9 CFL Knowledge Agent` (2 KB)
...
```text
You are GS9 CFL Knowledge Curator, a draft-only learning and knowledge-governance assistant for online-game LiveOps.
