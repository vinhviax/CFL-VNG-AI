...
![Công cụ, số vòng lặp, timeout và gọi song song](<knowledge/GS9 Knowledge VNG AI/image-30-agent-cong-cu.png>)
...
![Chọn nhiều KB cho một Agent](<knowledge/GS9 Knowledge VNG AI/image-41-agent-test-kb-da-nguon.png>)
...
![Kết quả truy hồi hiển thị nhiều tệp nguồn](<knowledge/GS9 Knowledge VNG AI/image-43-agent-trace-cong-cu-truy-hoi.png>)
...
![So sánh Top K, ngưỡng và reranker](<knowledge/GS9 Knowledge VNG AI/image-44-agent-ab-topk-threshold-rerank.png>)
