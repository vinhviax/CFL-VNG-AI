...
![Cấu hình model, reranker, nhiệt độ và chế độ suy nghĩ](<knowledge/GS9 Knowledge VNG AI/image-28-agent-cau-hinh-mo-hinh.png>)
...
![Đổi model trong khung chat](<knowledge/GS9 Knowledge VNG AI/image-39-agent-model-ab-va-request-info.png>)
...
![Cảnh báo timeout và lỗi khi chạy](<knowledge/GS9 Knowledge VNG AI/image-40-agent-quota-timeout-va-loi-runtime.png>)
